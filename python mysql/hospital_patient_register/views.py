...
class RegisterCreateListRetrieveUpdateDelete:
    ...
    def post(self,**kwargs):
        ...
        db_col = ("patient_name","phone_number","assigned_doctor","department","appointment_date","status","consultation_fee")
        ...
        print("......patient record has been registered.....")
    ...
    def retrieve(self,patient_name = None,phone_number = None):
        ...
        query = "select * from patients where patient_name = %s or phone_number = %s"

        values=(patient_name,phone_number)

        self.cursor.execute(query,values)

        patientss = self.cursor.fetchone()
    ...
    def put(self,patient_id = None ,**kwargs):
        ...
        print("patient records has been updated")
...
patient = RegisterCreateListRetrieveUpdateDelete(user = "root",password="Password@123")
# patient.post(
...
# patient.retrieve(phone_number = "8899123456")

# patient.put(patient_id=2,status = "pending")

# patient.delete(8)

# patient.filter(status = "pending",department="Neurology")
